...
\begin{itemize}
    \item Work on a simple model to learn how to use STAN
    \item Define the biological limitations of each species, the possible variation between stand and seed trap design
    \item Bayesian model using multi-species
...
\midrule
Week 1--2 & Getting familiar with STAN and define the possible variations between the variables (species/stand/traps) \\
Week 3--4 & Model specification and prior testing ? + Lab retreat (potentially working already on the manuscript; Method and overall sections) or something else? \\
...
\end{center}
\begin{itemize}
\item This is not certain as I have no idea how long each tasks would take me.
\end{itemize}
...
% Tasks
\ganttbar{Learning Stan + Define model limits?}{1}{1} \\
...
% Optional milestone
\ganttbar{Final presentation / report at lab meeting}{3}{3}\\
