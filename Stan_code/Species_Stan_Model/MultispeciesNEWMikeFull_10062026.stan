...
parameters {
  ...
  vector <lower=0> [S] sigma_stand_species;
...
transformed parameters {
  ...
  //     alpha_stand [s,st] = sigma_stand_species [s] * alpha_stand_nc[s,st];
...
model {
  ...
  for (s in 1:S) 
    alpha_stand [s]   ~ normal(0, sigma_stand_species[s]);
  sigma_stand_species     ~ normal(0.5, 1);
