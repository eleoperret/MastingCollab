...
model {
  ...
  // Grand means
  grand_logit_theta1 ~ normal(1.5, 0.7); //changed those priors here too
  grand_logit_theta2 ~ normal(0, 1);

  alpha_theta1_species_nc ~ normal(0,1);
  alpha_theta2_species_nc ~ normal(0,1);
  sigma_theta1_species ~ normal(0, 1);
  sigma_theta2_species ~ normal(0, 1);

  alpha_theta1_stand_nc ~ normal(0, 1);
  alpha_theta2_stand_nc ~ normal(0, 1);
  sigma_theta1_stand ~ normal(0, 1);
  sigma_theta2_stand ~ normal(0, 1);
