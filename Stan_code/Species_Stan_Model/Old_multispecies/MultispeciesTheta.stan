...
model {
  ...
  // theta1: probability of staying in low state
  theta1[1] ~ beta(5, 1);   // ABAM — mean 0.83
  theta1[2] ~ beta(5, 1);   // CANO — mean 0.83
  theta1[3] ~ beta(5, 1);   // PSME — mean 0.83
  theta1[4] ~ beta(5, 1);   // THPL — mean 0.83
  theta1[5] ~ beta(5, 1);   // TSHE — mean 0.83

  // theta2: probability of staying in high state
  theta2[1] ~ beta(1, 4);   // ABAM — mean 0.20
  theta2[2] ~ beta(1, 9);   // CANO — mean 0.10, 2-year cycle so high state rarely persists
  theta2[3] ~ beta(1, 4);   // PSME — mean 0.20
  theta2[4] ~ beta(1, 4);   // THPL — mean 0.20
  theta2[5] ~ beta(1, 4);   // TSHE — mean 0.20
  ...
  sigma            ~ normal(0, 0.5); #Issues with the previous one
