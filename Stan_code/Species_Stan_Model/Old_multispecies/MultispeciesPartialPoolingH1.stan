...
parameters {
  ...
  //Centered now
  vector[S] alpha_theta1_species;
  vector[S] alpha_theta2_species;
...
model {
  ...
  alpha_theta1_species ~ normal(0,sigma_theta1_species);
  alpha_theta2_species ~ normal(0,sigma_theta2_species);
