...
parameters {
  ...
  vector[N_stands] alpha_phi1_stand_nc;
  vector[N_stands] alpha_phi2_stand_nc;
...
transformed parameters {
  ...
  vector[N_stands] alpha_phi1_stand = sigma_phi1_stand * alpha_phi1_stand_nc;
  vector[N_stands] alpha_phi2_stand = sigma_phi2_stand * alpha_phi2_stand_nc;
  vector[F] log_phi1;
  vector[F] log_phi2;
  for (f in 1:F){
    int s = sp[start_idxs[f]];
...
model {
  ...
  alpha_phi1_stand_nc ~ normal(0, 1);
  alpha_phi2_stand_nc ~ normal(0, 1);
