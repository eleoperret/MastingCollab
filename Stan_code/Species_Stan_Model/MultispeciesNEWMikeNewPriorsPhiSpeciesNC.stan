...
model {
  ...
  sigma_low_species    ~ normal(0, 0.5);//Changed from the previous version MultispeciesNEWMike.stan
  alpha_low_stand_nc   ~ normal(0, 1);
  sigma_low_stand      ~ normal(0, 0.5);//Changed from the previous version MultispeciesNEWMike.stan
