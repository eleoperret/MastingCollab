#####################################################################
#### Script to generate clean seed data from MORA trap data      ####
#### Reads in raw data, but assumes data entry errors corrected  ####
#### Creates full seeds per m2 per trap, species and year        ####
#### This includes zeros, and adds germinants in traps           ####
#### NA's for destroyed / lost samples                           ####
#### Not including decommissioned / not yet established          ####
#####################################################################

###Read in seed data, seed trap size data, seedtrap history, and missing traps
