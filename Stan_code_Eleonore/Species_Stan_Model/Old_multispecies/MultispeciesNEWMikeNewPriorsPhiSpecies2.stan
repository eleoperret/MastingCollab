...
model {
  ...
  // --- Transitions ---
  grand_logit_theta1 ~ normal(1,   0.9); //Changed from the previous version MultispeciesNEWMike.stan 
  grand_logit_theta2 ~ normal(0,   0.9); //Changed from the previous version MultispeciesNEWMike.stan 
  ...
  sigma_theta1_stand    ~ normal(1.5, 0.7);//Changed from the previous version MultispeciesNEWMike.stan
  sigma_theta2_stand    ~ normal(1.5, 0.7);//Changed from the previous version MultispeciesNEWMike.stan
